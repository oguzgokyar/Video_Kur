                      ...
                      <div class="min-w-0 flex-1">
                        <div class="flex items-center gap-2 mb-1">
                          ...
                          <template x-if="script.isDefault">
                            <span class="text-[11px] text-green-700">varsayılan</span>
                          </template>
                        </div>
    ...
    <div class="bg-white rounded-xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
      ...
      <form @submit.prevent="saveScript()" class="p-6 space-y-4">
        ...
        <div class="flex items-center gap-2">
          ...
          <label class="text-sm font-medium text-gray-700">Bu kategori + video tipi için varsayılan script yap</label>
        </div>
